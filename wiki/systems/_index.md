...
- [[wiki/systems/Azure AI Search|Azure AI Search]] — Microsoft Azure's cloud search service used by the [[Team Wiki]] platform to host keyword (B2S) and vector indexes over wiki Markdown pages.
- [[wiki/systems/Azure Blob|Azure Blob]] — Microsoft Azure Blob Storage used by the [[Team Wiki]] platform as the raw files container.
- [[wiki/systems/Azure OpenAI|Azure OpenAI]] — Microsoft Azure's managed OpenAI service, used by the [[Team Wiki]] platform as the reasoning gateway.
- [[wiki/systems/Claude Code|Claude Code]] — Anthropic's AI coding assistant (CLI tool and IDE extension).
...
- [[wiki/systems/Team Wiki|Team Wiki]] — An internal knowledge base platform that ingests raw files (notes, transcripts, emails, scans) into structured Markdown wiki pages, indexes them for semantic search, and serves answers via a chat UI and MCP server.
